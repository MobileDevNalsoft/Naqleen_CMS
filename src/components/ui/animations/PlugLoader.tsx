...
export default function PlugLoader() {
    return (
        <div style={{
            ...
            width: '100%',
            height: '100%',
            minHeight: '300px', // Matches panel content height
            gap: '24px'
        }}>
            <style>
                {`
                    ...
                    @keyframes glowColor {
                     ...
                     @keyframes cableFlex {
                        0% { d: path('M 40 8.5 L 48 8.5'); }
                        20% { d: path('M 40 8.5 C 44 8.5, 44 8.5, 48 8.5'); } /* Compressed? No, actually just moving with group */
                        /* SVG transform handles movement, this is for subtle flex if needed. Skipping complex path anim for performance */
                    }
                `}
            </style>
