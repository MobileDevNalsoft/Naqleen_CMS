...
import { getEfficiency } from '../../../../apis/dashboardApi';
import type { EfficiencyResponse } from '../../../../types/dashboardTypes';
...
export default function FleetEfficiencyContent({
        ...
        return (
            <div style={{ height: '240px', width: '100%' }}>
                <PremiumStateView
                    ...
                    title="Efficiency Data Unavailable"
                    description="We couldn't calculate the fleet efficiency score."
                    action={{ label: "Retry Calculation", onClick: fetchStats }}
                    height="100%"
                />
            </div>
        );
    ...
    // Check for "Empty" data (all zeros) to avoid misleading 0% chart
    const allZeros = stats.overall === 0 && stats.truckUtilization === 0 && stats.driverUtilization === 0;
        ...
        return (
            <div style={{ height: '240px', width: '100%' }}>
                <PremiumStateView
                    ...
                    description="There is no efficiency data available for the selected period."
                    height="100%"
                />
            </div>
        );
        ...
        >
            ...
            <div style={{ position: 'relative', width: size, height: size, flexShrink: 0 }}>
                ...
                <div style={{
                    ...
                    <span style={{ fontSize: '9px', color: theme.colors.text.secondary, fontWeight: 700, letterSpacing: '0.04em', textTransform: 'uppercase' }}>Score</span>
                    <span style={{ fontSize: '18px', fontWeight: '800', color: theme.colors.text.primary, lineHeight: '1.1' }}>{overallScore}</span>
                </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <span style={{ fontSize: '13px', color: theme.colors.text.secondary, fontWeight: 600, marginBottom: '2px' }}>{trucksData.label}</span>
                    <div style={{ display: 'flex', alignItems: 'flex-end', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '16px', fontWeight: '700', color: theme.colors.text.primary, lineHeight: '1' }}>
                ...
                {/* Driver Legend */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <span style={{ fontSize: '13px', color: theme.colors.text.secondary, fontWeight: 600, marginBottom: '2px' }}>{driversData.label}</span>
                    <div style={{ display: 'flex', alignItems: 'flex-end', gap: '8px' }}>
                        <div style={{
                            width: '40%',
                            height: '6px',
