...
import { getDriversSummary } from '../../../../apis/dashboardApi';
import type { DriversResponse } from '../../../../types/dashboardTypes';
        ...
        return (
            <div style={{ height: '240px', width: '100%' }}>
                <PremiumStateView
                    ...
                    description="We encountered an issue fetching the latest driver summary stats."
        ...
        return (
            <div style={{ height: '240px', width: '100%' }}>
                <PremiumStateView
                    ...
                    title="No Drivers Data"
                    description="There is no drivers data available for the selected period."
                    height="100%"
                />
            </div>
        );
