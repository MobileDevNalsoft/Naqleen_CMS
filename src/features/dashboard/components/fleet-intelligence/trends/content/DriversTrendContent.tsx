...
import { getDriversTrend } from '../../../../apis/dashboardApi';
import type { DriversTrendResponse, TrendViewMode } from '../../../../types/dashboardTypes';
...
import { getDriverChartColor, getStatusIndex } from '../../../../../../utils/statusColors';
        ...
        return (
            <div style={{ height: '350px', width: '100%' }}>
                <PremiumStateView
                    ...
                    title="Unable to Load Driver Trends"
        ...
        return (
            <div style={{ height: '350px', width: '100%' }}>
                <PremiumStateView
                    ...
                    title="No Driver Trends"
                    description="There is no historical driver data available for the selected period."
                    height="100%"
                />
            </div>
        );
                ...
                >
                    ...
                    {uniqueStatuses.map((status, index) => (
                        <Bar
                            ...
                            dataKey={status}
                            name={status}
                            fill={getDriverChartColor(getStatusIndex(status))}
                            radius={[8, 8, 0, 0]}
