...
import type { ContainerByType } from '../../../types/dashboardTypes';
...
interface ContainersByTypeChartProps {
    data: ContainerByType[] | undefined;
    state: 'loading' | 'error' | 'default';
}

export default function ContainersByTypeChart({ data, state }: ContainersByTypeChartProps) {
    ...
    const chartData = data.map((item, i) => {
        ...
        return {
            ...
            bgColor: colorObj.bg,
            gradientUrl: `url(#grad-${colorObj.id}-type)`
        };
    });
    ...
    return (
        <>
            <div style={{
                ...
                width: '100%',
                height: '240px',
                animation: 'typeFadeIn 0.5s ease-out'
            }}>
                {/* Donut Chart Wrapper */}
                <div style={{ flex: '0 0 45%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <div style={{ position: 'relative', width: size, height: size, flexShrink: 0 }}>
                        <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} style={{ overflow: 'visible' }}>
                            <defs>
                                {PREMIUM_COLORS.map(c => (
                                    <linearGradient key={c.id} id={`grad-${c.id}-type`} x1="0%" y1="0%" x2="100%" y2="100%">
                                    ...
                                    >
                                        ...
                                        <path
                                            ...
                                            style={{
                                                ...
                                                animation: `typeDrawStroke 0.8s ease-out backwards ${index * 0.15}s`,
                                ...
                                return (
                                    <path
                                        ...
                                        style={{
                                            opacity: baseOpacity,
                                            transition: 'stroke-width 0.2s ease-out, opacity 0.2s ease-out, filter 0.2s ease-out',
                                            animation: `typeDrawStroke 0.8s ease-out backwards 0s`,
                                            filter: `drop-shadow(0px 8px 12px rgba(0,0,0,0.15))`
                                        }}
                        ...
                        <div style={{
                            ...
                            animation: 'typeScaleIn 0.5s ease-out 0.3s backwards',
                            ...
                            {hoveredIndex !== null ? (
                                <>
                                    ...
                                    <span style={{
                                        fontSize: '9px', color: theme.colors.text.secondary, fontWeight: 600,
                ...
                <div style={{
                    ...
                    rowGap: '10px',
                    alignItems: 'center',
                    animation: 'typeSlideInRight 0.5s ease-out 0.2s backwards',
                    overflowY: 'auto',
                    overflowX: 'hidden',
                    maxHeight: '240px',
                    paddingRight: '12px',
                    ...
                    {chartData.map((item, index) => (
                        <React.Fragment key={item.label}>
                            ...
                            >
                                ...
                                <span style={{ fontSize: '14px', color: '#475569', fontWeight: 500, whiteSpace: 'nowrap' }}>
                                    {item.label}
                                </span>
                            </div>
                            <span
