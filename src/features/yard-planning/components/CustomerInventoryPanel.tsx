...
import { createInventory, createBulkInventory, fetchCustomerLookup, fetchShipmentLookup, fetchCustomerStock, type CustomerStockItem } from '../apis/inventoryApi';
import { parseInventoryExcel } from '../../../services/excelImportService';
import type { InventoryRecord, InventoryItem, InventoryImportRow } from '../types/inventoryTypes';
                        ...
                        <div style={{ border: '1px solid #e2e8f0', borderRadius: '12px', overflow: 'hidden', background: 'white', flex: 1, display: 'flex', flexDirection: 'column' }}>
                            ...
                            <div style={{ overflowY: 'auto', flex: 1 }}>
                                {isLoadingStock ? (
                                    ...
                                    <GenericEmptyState
                                        title="No Inventory"
                                        description="No inventory records found for this criteria."
                                        icon={Package}
                                        type="data"
                                        height="100%"
                                    />
