...
import PlugIcon from '../../operations/icons/PlugIcon';
    ...
    return (
        <div
            ...
            style={{
                ...
                backgroundColor: theme.colors.glass.bg, // Subtle light secondary (Cream)
                backdropFilter: 'blur(24px) saturate(180%)',
                borderRadius: '24px',
                border: `1px solid ${theme.colors.glass.border}`, // Subtle primary border
                boxShadow: theme.shadows.floating,
                zIndex: 1000,
                color: theme.colors.text.primary, // Dark slate text
                display: 'flex',
            ...
            <div style={{ padding: '16px 24px 24px 24px', flex: 1, overflowY: 'auto' }} className="custom-scrollbar">
                {activeTab === 'details' && (
                    isLoading ? (
                        ...
                        <ContainerErrorState onRetry={() => refetch()} />
                    ) : !details ? (
                        <ContainerEmptyState />
                    ) : (
                ...
                {activeTab === 'lifecycle' && (
                    isLoading ? (
                        ...
                        <ContainerEmptyState message="No tracking events available" />
                    ) : (
...
const LifecycleStage = ({ date, time, title, status, isLast }: {
    ...
    const colors = {
        completed: { main: theme.colors.primary, bg: 'white', border: theme.colors.primary }, // Primary (Teal)
        current: { main: theme.colors.secondary, bg: 'white', border: theme.colors.secondary },   // Secondary (Gold/Orange)
    ...
    return (
        <div style={{ display: 'flex', gap: '16px', position: 'relative', minHeight: '66px' }}>
            ...
            <div style={{
                ...
                <div style={{ fontWeight: 700, color: theme.colors.text.primary, fontSize: '12px' }}>{date}</div>
                <div style={{ color: theme.colors.text.secondary, fontSize: '10px', marginTop: '2px' }}>{time}</div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative' }}>
                ...
                {!isLast && (
                    <div style={{
                        ...
                        bottom: '-16px',
                        width: '2px',
                        background: status === 'completed' ? theme.colors.primary : '#e2e8f0',
                        zIndex: 1
                    }} />
                )}
            </div>
    ...
    return (
        <button
            ...
            style={{
                ...
                transition: 'all 0.2s',
                boxShadow: primary && !disabled ? `0 4px 12px ${theme.colors.primary}4d` : '0 2px 4px rgba(0,0,0,0.05)',
