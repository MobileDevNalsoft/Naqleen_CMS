...
import { Check, X, Loader2, Shield, Trash2, AlertTriangle, Plus, ShieldAlert, FileX } from 'lucide-react';
...
import type { RoleConfig } from '../types/adminTypes';
                        ...
                        <div style={{ flex: 1, overflowY: 'auto' }}>
                            ...
                            {masterScreens.length === 0 && (
                                <GenericEmptyState
                                    ...
                                    description="No master screens found in system"
                                    icon={FileX}
                                    height="300px"
                                />
                            )}
