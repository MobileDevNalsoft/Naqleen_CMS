...
import ToastContainer, { showToast } from '../../../components/ui/feedback/common/Toast';
...
const TruckCab = ({ headlightsOn, errorMode, isLoading }: { headlightsOn: boolean; errorMode: boolean; isLoading: boolean }) => {
    ...
    const coreColor = errorMode ? theme.colors.error : "#FDE68A";
    const spreadColor = errorMode ? "#b91c1c" : theme.colors.secondary;
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke={theme.colors.secondary} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <h1 style={{
                        fontSize: '46px', fontWeight: 800, color: theme.colors.text.inverted,
                    ...
                    <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                        {[
                            { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={theme.colors.secondary} strokeWidth="1.5"><path d="M12 2L2 7l10 5 10-5-10-5z" /><path d="M2 17l10 5 10-5" /><path d="M2 12l10 5 10-5" /></svg>, label: '3D Visualization' },
                            { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={theme.colors.secondary} strokeWidth="1.5"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /></svg>, label: 'Smart Tracking' },
                            { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={theme.colors.secondary} strokeWidth="1.5"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></svg>, label: 'Real-time Updates' },
                        ].map((item, i) => (
                            <div key={i} style={{ padding: '8px 14px', background: 'rgba(0,0,0,0.2)', backdropFilter: 'blur(5px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '7px', fontSize: '12px', color: theme.colors.text.inverted, fontWeight: 500 }}>
            ...
            <div style={{
                ...
                <div style={{ width: '100%', maxWidth: '320px', position: 'relative', zIndex: 30 }}>
                    <div style={{ marginBottom: '30px', textAlign: 'center' }}>
                        <h2 style={{ fontSize: '28px', fontWeight: 700, color: theme.colors.text.inverted, marginBottom: '8px' }}>Welcome back</h2>
                    ...
                    <form onSubmit={handleSubmit} autoComplete="off">
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <Mail size={18} color={theme.colors.secondary} style={{ position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', zIndex: 1 }} />
                                <input
                                    type="email"
                        ...
                        <div style={{ marginBottom: '28px' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <Lock size={18} color={theme.colors.secondary} style={{ position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', zIndex: 1 }} />
                                <input
                        ...
                        <button
                            ...
                            style={{
                                ...
                                border: 'none', color: theme.colors.text.primary, fontSize: '15px', fontWeight: 700,
            ...
            <style>{`
                ...
                .glass-input:-webkit-autofill:active {
                    -webkit-box-shadow: 0 0 0 30px ${theme.colors.primary} inset !important;
                    -webkit-text-fill-color: ${theme.colors.text.inverted} !important;
